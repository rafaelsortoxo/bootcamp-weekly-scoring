      ...
      <Row noGutters>
        ...
        <Col xs="2">
          <input
            ...
            value={this.state.weekData.ftar[0] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.ftar[1] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.ftar[2] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.ftar[3] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.ftar[4] || 0}
            size="2"
          />
        </Col>
      </Row>
      ...
      <Row noGutters>
        ...
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.productivity[0] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.productivity[1] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.productivity[2] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.productivity[3] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.productivity[4] || 0}
            size="2"
          />
        </Col>
      </Row>
      ...
      <Row noGutters>
        ...
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.scores[0] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.scores[1] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.scores[2] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.scores[3] || 0}
            size="2"
          />
        </Col>
        <Col xs="2">
          <input
            ...
            className="form-control"
            disabled={this.props.mode === 'view' || this.props.auth.role === 'ic'}
            value={this.state.weekData.scores[4] || 0}
            size="2"
          />
        </Col>
      </Row>
